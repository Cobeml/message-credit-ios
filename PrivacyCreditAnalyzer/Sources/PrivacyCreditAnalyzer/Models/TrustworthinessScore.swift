...
public struct TrustworthinessScore: Codable, Equatable {
    public let score: Double // 0.0 to 1.0
    public let factors: [String: Double]
    public let explanation: String
    
    public init(score: Double, factors: [String: Double], explanation: String) {
    ...
    public func calculateWeightedScore() -> Double {
    ...
    public func primaryFactor() -> (key: String, value: Double)? {
